 ...
 * @author gq
 */
public class PulllScrollHeaderView extends LinearLayout {
	...
	public PulllScrollHeaderView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public PulllScrollHeaderView(Context context) {
		super(context);
		LayoutInflater.from(context).inflate(R.layout.common_pull_header, this);
		init(context);
	}
