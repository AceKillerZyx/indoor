 ...
 * 
 */
public class PulllScrollFooterView extends LinearLayout {
	...
	public PulllScrollFooterView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public PulllScrollFooterView(Context context) {
		super(context);
		LayoutInflater.from(context).inflate(R.layout.common_pull_footer, this);
	...
	public int setStartLoad() {
		...
		if (!isArrowsUp) {
			RotateAnimation mReverseFlipAnimation = new RotateAnimation(180, 0,
	...
	public void setPaddingButtom(int paddingButtom) {
		this.setPadding(0, 0, 0, paddingButtom);
		arrows.clearAnimation();
	}
