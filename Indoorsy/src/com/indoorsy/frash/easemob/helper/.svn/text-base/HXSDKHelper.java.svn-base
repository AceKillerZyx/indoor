...
import com.indoorsy.frash.easemob.model.DefaultHXSDKModel;
 ...
 *
 */
@SuppressLint("ShowToast") public abstract class HXSDKHelper {
    ...
    public synchronized boolean onInit(Context context){
        ...
        Log.d(TAG, "process app name : " + processAppName + "--hxModel:" + hxModel.getAppProcessName());
        ...
        String stAppKey = sharedPreFerencesAppKey.getString("customerappkey", Constants.CUSTOMERAPPKEY);
        Log.e(TAG, "stAppKey:" + stAppKey);
...
//        }
    ...
    public String getHXId(){
    	...
    	String stname = sharedPreferences.getString("name", "whz");
