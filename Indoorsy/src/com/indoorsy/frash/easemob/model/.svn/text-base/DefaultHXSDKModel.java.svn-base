 ...
 */
package com.indoorsy.frash.easemob.model;
...
import com.indoorsy.frash.easemob.db.UserDao;
import com.indoorsy.frash.easemob.util.HXPreferenceUtils;
 ...
 *
 */
@SuppressLint("ShowToast") public class DefaultHXSDKModel extends HXSDKModel{
