...
public class ExpandTabTextAdapter extends ArrayAdapter<String> {
	...
	public ExpandTabTextAdapter(Context context, List<String> listData, int sId, int nId) {
		super(context, R.string.common_no_data, listData);
		mContext = context;
		mListData = listData;
	...
	public ExpandTabTextAdapter(Context context, String[] arrayData, int sId, int nId) {
		super(context, R.string.common_no_data, arrayData);
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		TextView view;
		if (convertView == null) {
			view = (TextView) LayoutInflater.from(mContext).inflate(R.layout.homepage_productlist_expandtab, parent, false);
		} else {
